...
const houseData = {
  ...
  "2": { name: "RU Apartment", location: "456 Hamilton St, Highland Park, NJ", amenities: ["2 Bedrooms", "1 Bathroom", "Kitchen", "Laundry"], reviews: [{ user: "Resident X", rating: 4, comment: "Nice and quiet." }] },
